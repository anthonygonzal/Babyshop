					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i>09554830714</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> gonzalanthony22@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
...
<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left"></p>
					<p class="pull-right">Designed by <span><a target="_blank" href="#">gonzal</a></span></p>
				</div>
			</div>
		</div>
