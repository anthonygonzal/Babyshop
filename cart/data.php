...
class Shopping {
    ...
    function countorder(){
        $q = "select * from babiesclothes.order where status='unconfirmed'";
        $result = mysql_query($q);
        echo mysql_num_rows($result);
    }
    function countproducts(){
        $q = "select * from babiesclothes.products";
        $result = mysql_query($q);
        echo mysql_num_rows($result);
    }
    function countcategory(){
        $q = "select * from babiesclothes.category";
        $result = mysql_query($q);
        echo mysql_num_rows($result);
    }
    function checkout(){
        ...
        echo $q = "INSERT INTO babiesclothes.order VALUES (NULL, '$fullname', '$contact', '$address', '$email', '$item', '$amount', 'unconfirmed', '$date', '')";
    ...
    function verify(){
        ...
        $q = "SELECT * from babiesclothes.user where username='$username' and password='$password'";
        $result = mysql_query($q);
        $_SESSION['login']='yes';
        echo mysql_num_rows($result);
    }
